...
public class reflect_air_predict extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reflect_air_predict);

        editText = findViewById(R.id.impedance_value_air);
        result = findViewById(R.id.result_mineral_air);
        predict = findViewById(R.id.predict_air);
        refresh = findViewById(R.id.refresh_air);
        progress = findViewById(R.id.progress_text_air);
        progressBar = findViewById(R.id.processing_air);
        ...
        requestQueue = Volley.newRequestQueue(reflect_air_predict.this);
        ...
        predict.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = "https://mineral-predict.herokuapp.com/predict_air";
